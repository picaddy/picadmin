...
abstract class BaseIdeeForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'idee_projet_type_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('ProjetType'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'idee_projet_type_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('ProjetType'))),
