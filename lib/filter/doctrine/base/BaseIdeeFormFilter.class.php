...
abstract class BaseIdeeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'idee_projet_type_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('ProjetType'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'idee_projet_type_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('ProjetType'), 'column' => 'id')),
  ...
  public function getFields()
  {
    return array(
      ...
      'idee_projet_type_id' => 'ForeignKey',
